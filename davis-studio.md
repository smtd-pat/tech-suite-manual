...
- <input type="checkbox"> Tables should be arranged in a U shape facing the projector screen with 2 chairs at each table
...
### Touch Panel
Use the touch panel next to the north side door to control the Davis overhead lights
...
All grey outlets are typically programmed to be perpetually on, however some provide power to a few speakers and hence is turned on and off using the [speaker system power switch](#speaker-system-power).
